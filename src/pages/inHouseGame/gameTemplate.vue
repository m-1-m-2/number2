<template>
  <div class='gameTemplateGame q-px-md'>
    <!-- 展示区 -->
    <div class="h-500 full-width bg-red"></div>
    <!-- 投注选项区域 -->
    <div class="q-mt-md">
...
export default defineComponent({
  ...
  mounted () {
    ...
    // 处理相关ws返回
    this.SOCKET.on('games.gameTemplate.bet', (res) => {
      // console.log(res)
    })
  },
  methods: {
  ...
  computed: {},
  unmounted () {
    this.SOCKET.off('games.gameTemplate.bet')
  }
})
</script>
